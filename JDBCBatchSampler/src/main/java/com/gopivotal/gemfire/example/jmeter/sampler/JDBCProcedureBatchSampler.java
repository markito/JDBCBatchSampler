 ...
 */
public class JDBCProcedureBatchSampler extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext context) {
        ...
        String sqlString = context.getParameter("Procedure with Params");
    ...
    public Arguments getDefaultParameters()
    {
        ...
        defaultParameters.addArgument("Procedure with Params", "{call myProcedure(?,?)}");
